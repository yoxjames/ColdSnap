...
public interface MainActivityDataProvider
{
    Observable<WeatherData> getWeatherDataProvider();
    Observable<List<Plant>> getPlantDataProvider();
    void pushLocation(SimpleWeatherLocation location);
}
