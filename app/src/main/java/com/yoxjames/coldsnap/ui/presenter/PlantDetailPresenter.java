...
public interface PlantDetailPresenter
{
    ...
    /**
     * Saves the current state of the plant bound to this view.
     */
    void savePlantInformation();

    /**
     * Deletes the plant that this view is for.
     *
     */
    void deletePlant();

    /**
     * Unloads all listeners/observables.
     */
    void unload();
}
