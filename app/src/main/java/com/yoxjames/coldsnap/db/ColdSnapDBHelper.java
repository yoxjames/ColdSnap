...
import static com.yoxjames.coldsnap.db.ColdsnapDbSchema.ForecastDayTable;
...
public class ColdSnapDBHelper extends SQLiteOpenHelper
{
    ...
    {
        db.execSQL("create table " + ColdsnapDbSchema.ForecastDayTable.NAME + "(" +
    ...
    {
        db.execSQL("drop table " + ColdsnapDbSchema.ForecastDayTable.NAME);
        db.execSQL("create table " + ColdsnapDbSchema.ForecastDayTable.NAME + "(" +
                " _id integer primary key autoincrement, " +
                ForecastDayTable.Cols.UUID + ", " +
                ForecastDayTable.Cols.FETCH_DATE + ", " +
